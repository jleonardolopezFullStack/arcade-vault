/**
 * Siluetas pixel decorativas del hero, portadas de home.jsx.
 *
 * El relleno va en el propio SVG; la posición, el tamaño, el color del
 * resplandor y el desfase de la animación viven en `.home-silos .sN` de
 * globals.css.
 */
export function FloatingSilhouettes() {
  return (
    <div
      className="home-silos pointer-events-none absolute inset-0 z-[1] opacity-55"
      aria-hidden="true"
    >
      {/* s1: invasor */}
